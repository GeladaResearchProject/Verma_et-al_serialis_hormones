...
Requires: tenures.csv; taenia_infection.csv
...
ten_long = read.csv("~/tenures.csv") # paths removed
ten_long = ten_long %>%
  mutate(
...
# compute % shorter
pct_shorter_mean = (1 - results$mean_length[results$group == "-2"] /
                         results$mean_length[results$group == "-1"]) * 100

pct_shorter_median = (1 - results$median_length[results$group == "-2"] /
                           results$median_length[results$group == "-1"]) * 100
...
df_samples = read.csv("~/taenia_infection.csv")
